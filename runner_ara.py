...
## ara x parallel pipelining/interfacing
def run_adjoin_code_parallel(train_file_path, stream_file_path, is_train=True):
    if is_train:
...
## ara-decision-component
def run_ara_monitor_decision():
    pass
